...
def render_processor(main_system):
    for entity, (Render) in main_system.get_entities_with(Render):
        pass
...
class MainSystem:
    ...
    def get_entities_with(self, *components_types):
        for c_type in components_types:
            pass
...
class App:
    def __init__(self):
        ...
        self.ecs = MainSystem()
        self.ecs.add_entity(Render(50, 50, SPRITEUP))
